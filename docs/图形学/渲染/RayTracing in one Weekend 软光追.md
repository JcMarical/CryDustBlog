...
可以获得三种求交情况
![](res/Pasted%20image%2020240720002750.png)
## 2.曲面法线和多对象
最近表面光线 =  判别式负号的那一个
法线 = 表面-圆中心
...
两个球的效果
![](res/Pasted%20image%2020240721223448.png)
...
## 5.镜面反射
![](res/Pasted%20image%2020240729222348.png)
* 反射向量计算函数reflect()
* 添加**新的金属材质**，并进行光线反射计算
...
![](res/Pasted%20image%2020240730130928.png)
1. 构造增添模糊度（金属度）
...
# 1.相机视野几何体
* 确定Fov，焦距，可算出高度的比率
![](res/Pasted%20image%2020240730233425.png)
## 2.确定相机的位置和定向
